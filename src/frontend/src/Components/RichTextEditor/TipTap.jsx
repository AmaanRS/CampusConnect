...
export default function TipTap({ getEditorContent, content = "" }) {
    ...
    <div className="">
      <div className="border border-slate-300 rounded-md  ">
        ...
        <EditorContent
          ...
          className="custom-scrollbar editor-padding max-h-96 overflow-auto"
          editor={editor}
        />
      </div>
    </div>
