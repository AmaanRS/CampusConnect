...
export default function RightSidebar() {
  return (
    <>
      <div className=" custom-scrollbar overflow-hidden  hover:overflow-auto fixed top-0 right-0 h-screen w-72 bg-white border-gray-300 border-l-[1px] p-4 hidden sm:block">
